...
public class ThanosWinApp {

    private static final Logger log = LoggerFactory.getLogger(ThanosWinApp.class);

    private final Environment env;

    public ThanosWinApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes ThanosWin.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ThanosWinApp.class);
